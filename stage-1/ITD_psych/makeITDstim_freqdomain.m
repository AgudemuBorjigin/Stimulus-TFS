function out = makeITDstim_freqdomain(ITD, rightOrLeft, fc, fs, dur, ramp)
%--------------------------------------
...
sig_lead = rampsound(ifft(Xf, 'symmetric'), fs, ramp);
sig_lag = rampsound(ifft(Xf.*Xphase, 'symmetric'), fs, ramp);
