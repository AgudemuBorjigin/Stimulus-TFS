function [respList, ITDList, thresh] = ...
    getThreshITD(sID,fc, TFSorENV, blockNum, nBlocks,useTDT,...
...
try
    ...
    L = 65; % AB: Fixed value at 65 dBSPL 
    ITD = 180e-6; % AB: starting ITD value, big enough to make sure the subject understands the task
    stepDown = -20e-6; % AB: stepDown from initail ITD, CHANGE AS NEEDED
    stepUp = Nup*(-stepDown);
    ...
    while(~converged)
        ...
        WaitSecs(1.5); % stimulus duration 
        %%
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
        %  Response Frame
        %%%%%%%%%%%%%%%%%%%%%%%%%%%%%
