function [correct] = getCorrectITD(leftOrRight, TFSorENV, sID,fc, fm, ITD, dur, ramp, trigNumLorR, trialNum, BlockNum,useTDT,...
    buttonBox, PS)
...
try
    ...
    y = makeITDstim(leftOrRight,ITD, fc, fs, fm, dur, ramp, TFSorENV);
    ...
    if useTDT
        ...
        invoke(PS.RP, 'SetTagVal', 'trgname', trigNumLorR);
    ...
    WaitSecs(1.5); % make sure there is a delay after the stimulus 
