# MRT Results Distribution

>Modified Rhyme Test Database
>NTIA/ITS.P PSCR
>July 2007
>(modified February 2013)

This database contains recordings of five males and four females reading the 300 words of a modified
rhyme test, as outlined in section 8.3 of ANSI S3.2-1989. These recordings were made in the Public Safety Communication Research Audio Testing Laboratory at the Institute for Telecommunication Sciences (ITS) in Boulder, CO. All
files have been normalized to 28dB below clipping, using the "Speech Voltmeter" given in ITU-T Rec. P.56. The recordings are 16 bit .wav files and are sampled at 48ksamp/sec.
The database contains a total of 2700 recordings.

File naming convention:
Speaker_Box_Word_orig.wav
	Speaker: the two character speaker ID. M stands for male, and F for female.
	Box:     the box/ensemble/list  number of the recording (b1 to b50)
	Word:    the word number of the recording (w1 to w6)

The words in the table below were applied to the sentence “Please select the word _________.”
